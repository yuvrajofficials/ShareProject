            ...
            <div class="h-full bg-gray-200 p-8">
                <div class="bg-white rounded-lg shadow-xl pb-8">
                    ...
                    <div class="w-full h-[250px]">
                        <img src="https://img.freepik.com/premium-photo/modern-corporate-architecture-can-be-seen-cityscape-office-buildings_410516-276.jpg" class="w-full h-full rounded-tl-lg rounded-tr-lg" />
                    </div>
                        {contents?.map((p) => (
                    <div class="flex flex-col items-center -mt-20">

                <img src={`/api/v1/auth/profile-photo/${p._id}`} class="w-40 border-4 border-white rounded-full"/>
                ...
                <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                    ...
                    <div class="flex flex-col w-full 2xl:w-2/3">
                        <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                            ...
                            <p class="mt-2 text-gray-700">I am  Software Developer by profession who has skills of designing and coding software for businesses and consumers alike. I have worked closely with clients to determine what they need, then used programming languages like Java or C++ to create programs. I have critical thinking skills, as well as strong problem-solving abilities .</p></div>
                        <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                ...
                <div class="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-8 mt-8">
                        <FriendListGenerate friendfeatures="Senior Software Developer" friendname="Robert " />
                        <FriendListGenerate friendfeatures="Senior Software Developer" friendname="Robert " />
                        <FriendListGenerate friendfeatures="Senior Software Developer" friendname="Robert " />
                        <FriendListGenerate friendfeatures="Senior Software Developer" friendname="Robert " />
                        <FriendListGenerate friendfeatures="Senior Software Developer" friendname="Robert " />
