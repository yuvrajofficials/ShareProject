    ...
    const UploadMaterial = () => {
        ...
        const [materialfile, setMaterial] = useState("");    
        ...
        const [description, setDescription] = useState("");
         ...
         const handleCreate = async (e) => {
          ...
          try {
              ...
              productData.append("materialfile", materialfile);
              productData.append("description", description);
              const { data } = axios.post(
                  "/api/v1/studymaterial/material-upload",
                  productData
              );
              if (data?.success) {
                  alert(data?.message);
    ...
    >
      ...
      <div class="mb-5">
        <label
          ...
          class="mb-3 block text-base font-medium text-[#07074D]"
        >
          Set Description of Study Material :
        </label>
        <input
          type="text"
          name="description"
      ...
      <div class="mb-6 pt-4">
        ...
        <div class="mb-8">
          <input type="file" name="file" id="file" onChange={(e) => setMaterial(e.target.files[0])}
                                             class="sr-only" />
          <label
            for="file"
